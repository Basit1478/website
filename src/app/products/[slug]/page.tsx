...
const ProductListing = ({ params }: { params: Promise<{ slug: string }> }) => {
  const { slug } = React.use(params); // Unwrap the Promise to access the actual slug
  ...
  function setCurrentSlug(slug: string): void {
